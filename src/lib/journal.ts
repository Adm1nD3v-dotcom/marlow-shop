export const posts = [
  ...
  {
    slug: "rechargeable-patio-lantern",
    title: "A rechargeable patio lantern that sits at the table",
    dek: "USB-C, eight-hour burn, amber field. How Halo is meant to be used.",
    productSlug: "halo-lantern",
    body: [
  ...
  },
  {
    ...
    title: "Solar string lights without an outdoor outlet",
    dek: "Ten metres of bone-white filament. A dusk-to-dawn sensor. The pergola, finished.",
    productSlug: "filament-lights",
    body: [
      "Filament is ten metres of solar string lights with a bone-white filament. No outdoor outlet. A dusk-to-dawn sensor turns them on when the yard actually wants them.",
      "They want a few hours of sky. A covered porch with a sliver of sun is enough; a north well is not. Hang them, then add Halo on the table. That is the evening kit.",
    ],
  },
  {
    slug: "evening-kit",
    title: "The evening kit is $62",
  ...
  {
    slug: "solar-without-the-strobe",
    title: "Solar without the strobe",
